...
你可以通过修改 `app/page.tsx` 来编辑页面，页面会在你编辑文件时自动更新。

本项目使用 [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) 自动优化并加载 [Geist](https://vercel.com/font)，这是 Vercel 推出的一款新字体。
...
欢迎查看 [Next.js GitHub 仓库](https://github.com/vercel/next.js)，期待你的反馈和贡献！
